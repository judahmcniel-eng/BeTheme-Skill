...
**One-click ready for Claude Projects & Claude Code**

### 🚀 How to Add This Skill to Claude (Takes 10 Seconds)

**Best way (recommended):**
1. Open [claude.ai](https://claude.ai) → go to any **Project** (or create a new one).
2. In the **Knowledge** section, click the **+** button → choose **GitHub**.
3. Paste this repo URL:  
   `https://github.com/judahmcniel-eng/BeTheme-Skill`
4. Select the `README.md` file → click **Add**.

Claude will automatically load the entire cinematic BeTheme skill and keep it synced.

**Alternative (no GitHub login):**
- Click the **Raw** button at the top of this README → copy everything → paste into Claude Knowledge as a new file.
